%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This script is developed to simulate the phase_field phenomenon governed %
...
% 1. Download the documents 'Phase_Field.m' and 'Phase_Field.fig';           %
...
function varargout = Phase_Field(varargin)
% PHASE_FIELD MATLAB code for Phase_Field.fig
%      PHASE_FIELD, by itself, creates a new PHASE_FIELD or raises the existing
%      singleton*.
%
%      H = PHASE_FIELD returns the handle to a new PHASE_FIELD or the handle to
%      the existing singleton*.
%
%      PHASE_FIELD('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PHASE_FIELD.M with the given input arguments.
%
%      PHASE_FIELD('Property','Value',...) creates a new PHASE_FIELD or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Phase_Field_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Phase_Field_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Phase_Field

% Last Modified by GUIDE v2.5 19-Mar-2020 15:03:39

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Phase_Field_OpeningFcn, ...
                   'gui_OutputFcn',  @Phase_Field_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Phase_Field is made visible.
function Phase_Field_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Phase_Field (see VARARGIN)
...
% Choose default command line output for Phase_Field
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Phase_Field wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Phase_Field_OutputFcn(hObject, eventdata, handles) 
